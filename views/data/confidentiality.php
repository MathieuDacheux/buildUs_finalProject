<div class="desktopGutter">
    ...
    <main class="flexCenterCenterColumn">
        <h1 class="important">Politique de confidentialité</h1>

        <p>
            Le site web buildus.fr est détenu par BuildUs, qui est un contrôleur de données de vos données personnelles.
        </p>
        <p>
            Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par buildus.fr, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d'utiliser le site web de buildus.fr.
        </p>
        <p>
            Nous prenons soin de vos données personnelles et nous nous engageons à en garantir la confidentialité et la sécurité.
        </p>

        <h2>Les <span class="important">informations personnelles</span> que nous collectons</h2>

        <p>
            Lorsque vous visitez le buildus.fr, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme "informations sur les appareils". En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s'y limiter, le nom, le prénom, l'adresse, les informations de paiement, etc.) lors de l'inscription afin de pouvoir exécuter le contrat.
        ...
        <h2><span class="important">Liens</span> vers d'autres sites web</h2>
        ...
        <h2><span class="important">Sécurité</span> de l'information</h2>
        ...
        <h2>Divulgation<span class="important"> légale</span></h2>
        ...
        <h2>Informations de <span class="important">contact</span></h2>

        <p>
            Si vous souhaitez nous contacter pour comprendre davantage la présente politique ou si vous souhaitez nous contacter concernant toute question relative aux droits individuels et à vos informations personnelles, vous pouvez envoyer un courriel à mathieu.dacheux@icloud.com. 
        </p>
    </main>
