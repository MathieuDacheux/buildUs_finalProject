<div class="desktopGutter">
    ...
    <header>
        <nav class="flexCenterBetween">
            ...
            <div class="desktopNav flexCenterBetween">
                <a href="/accueil#pricing">Tarifs</a>
                <a href="/accueil#features">Fonctionnalités</a>
    ...
    <main class="flexCenterCenterColumn">
        <h1 class="important">CONDITIONS D'UTILISATION</h1>

        <p>
            Ce site web est exploité par BuildUs. Partout sur le site, nous employons les termes « nous », « notre » et « nos » 
            en référence à BuildUs. Ce site web, y compris l'ensemble des informations, outils et services auquel il donne accès, 
            est offert par BuildUs à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, 
        ...
        <p>
            ...
            prenez part à notre « Service » et acceptez d'être lié(e) par les modalités et conditions suivantes 
            ...
            d'utilisation s'appliquent à tous les utilisateurs du Site, y compris, sans s'y limiter, aux individus
            qui sont des visiteurs, des fournisseurs, des clients, des marchands et/ou des fournisseurs de contenu.
            Veuillez lire attentivement les présentes Conditions d'utilisation avant d'accéder à notre site web 
            et de l'utiliser. En accédant à une quelconque partie du Site ou en l'utilisant, vous acceptez d'être
            lié(e) par les présentes Conditions d'utilisation. Si vous n'acceptez pas la totalité des modalités et 
            conditions du présent accord, vous ne pourrez peut-être pas accéder au site web ou utiliser ses services. 
        ...
        <h2><span class="important">Section 1</span> – Conditions d'utilisation de la boutique en ligne</h2>
        ...
        <h2><span class="important">Section 2</span> – Conditions générales</h2>
        ...
        <h2><span class="important">Section 3</span> - Exactitude, Exhaustivité et actualité des informations</h2>
        ...
        <h2><span class="important">Section 4</span> - Modification du service et des prix</h2>
        ...
        <h2><span class="important">Section 5</span> - Produits ou services (le cas écheant)</h2>
        ...
        <h2><span class="important">Section 6</span> - Exactitude de la facturation et les informations de compte</h2>
        ...
        <h2><span class="important">Section 7</span> - Outils facultatifs</h2>
        ...
        <h3><span class="important">Article</span> - Lien de tiers</h3>
        ...
        <h3><span class="important">Article</span> - Commentaires, retours d'expérience et autrs soumissions</h3>
        ...
        <h3><span class="important">Article</span> - Informations personnelles</h3>
        ...
        <h3><span class="important">Article</span> - Erreurs, inexactitudes et omissions</h3>
        ...
        <h3><span class="important">Article</span> - Utilisations interdites</h3>
        ...
        <h3><span class="important">Article</span> - Exclusion de garanties et limitation de responsabilité</h3>
        ...
        <h3><span class="important">Article</span> - Résiliation</h3>
        ...
        <h3><span class="important">Article</span> - Intégralité de l'accord</h3>
        ...
        <h3><span class="important">Article</span> - Loi applicable</h3>

        <p>
            Les présentes Conditions d’utilisation, ainsi que tout accord distinct par lequel nous vous fournissons les Services sont régis et interprétés en vertu des lois de 110 Rue du Maréchal de Lattre de Tassigny, Amiens, France, 80000, France.
        </p>

        <h3><span class="important">Article</span> - Modifications apportées aux conditions d'utilisation</h3>
        ...
        <h3><span class="important">Article</span> - Coordonnées</h3>

        <p>
            Les questions relatives aux Conditions d’utilisation doivent nous être envoyées à mathieu.dacheux@icloud.com.
        </p>
    </main>
    <!-- Footer  -->
        
    <footer class="flexCenterCenterColumn">
        <div class="containerLogo flexCenterBetween">
            <img src="../public/assets/icons/logo.svg" alt="Logo du logiciel BuildUs">
            <h3>BuildUs</h3>
        </div>
